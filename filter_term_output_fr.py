...
##filter_term_output_fr


import os
import sys

from filter_terms_fr import *


def main(args):
    global special_domains
    
    #input 1: file containing ranked terms from Stage 2
    file_prefix = args[1]
    ...
    filter_terms_fr(input_file,output_file,abbr_full_file,full_abbr_file,
                 use_web_score=use_web_score,numeric_cutoff=max_term_number,
                 reject_file=reject_file,web_score_dict_file=web_score_dict_file,
                 abbr_files=abbr_file_list)
    ##removed arg: abbr_files=abbr_file_list
