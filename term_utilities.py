...
stat_adj_dict = {}  ## @func comp_termChunker, @arch static state
stat_term_dict = {}  ## @func comp_termChunker, @arch static state
noun_base_form_dict = {}  ## @func comp_termChunker, @arch static state
plural_dict = {}  ## @arch static state
verb_base_form_dict = {}  ## @arch static state
verb_variants_dict = {}  ## @arch static state
nom_dict = {}
pos_dict = {}
