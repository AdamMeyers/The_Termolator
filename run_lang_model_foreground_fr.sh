...
python3 ./make_io_file.py "${foreground_location}_list.txt" "${foreground_location_og}_test.internal_prefix_list" BARE
python3 ./make_termolator_fact_txt_files.py "${foreground_location_og}_test.internal_prefix_list" .txt
python3 ./make_io_file.py "${foreground_location}_list.txt" "${foreground_location_og}_test.internal_txt_fact_list" .txt3 .fact2
python3 ./make_io_file.py "${foreground_location}_list.txt" "${foreground_location_og}_test.filter2_io" .txt3 .fact .fact2
python3 ./run_make_filtered_fact_files_FR.py "${foreground_location_og}_test.filter2_io" $2

#create filtered documents
python3 ./make_filtered_doc_fr.py "${foreground_location_og}_test.filter2_io"
